...
<div id="show-user" class="content scaffold-show" role="main">
    ...
    <ol class="property-list user">
        ...
        <g:if test="${userInstance?.homepage}">
            <li class="fieldcontain">
                <span id="homepage-label" class="property-label"><g:message code="user.homepage.label"
                                                                            default="Homepage"/></span>

                <span class="property-value" aria-labelledby="homepage-label"><g:fieldValue bean="${userInstance}"
                                                                                            field="homepage"/></span>
